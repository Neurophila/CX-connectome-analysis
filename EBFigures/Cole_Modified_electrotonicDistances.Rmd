...
```{r}
if(savePlot){
  pdf(paste('cole_plots/example', nronType, '_RP.pdf', sep=""))
}
...
synapses = synapses %>% 
  mutate(modality = case_when(
    ...
    partnerType %in% DNa03 ~ 'DNa03',
    partnerType %in% Vest ~ 'Vest',
    partnerType %in% Posterior_Slope ~ 'Posterior_Slope',
...
modalityCMap =c(green,Vivid_Blue,Vivid_Violet,pink,darker_Blue, cyan, cyan, cyan)
...
modalityCDFPlot = ggplot(filter(synapsesPre, bodyid == nron_info_kept$bodyid[egNum], modality %in% c('all','LAL', 'PFLs', 'DNa03', 'MZ_inter')), aes(x = normEDist, color = modality)) +
    stat_ecdf(geom = "step") +
...
if(savePlot){
ggsave(paste('modalityCDF_', nronType, '_ED.pdf', sep = ""), plot = modalityCDFPlot, device='pdf', path = "cole_plots")
}
...
modalityCDFPlot = ggplot(filter(synapsesPre, bodyid == nron_info_kept$bodyid[egNum], modality %in% c('PFLs', 'DNa03', 'MZ_inter')), aes(x = distToRoot, color = modality)) +
    stat_ecdf(geom = "step") +
    scale_colour_manual(values = modalityCMap) +
    theme_paper() +
...
if(savePlot){
ggsave(paste('modalityCDF_', nronType, '_RD.pdf', sep = ""), plot = modalityCDFPlot, device='pdf', path = "cole_plots")
}
...
```{r}
medOfEDist_nronType = filter(synapses, prepost == 1, modality %in% c('PFLs', 'DNa03', 'MZ_inter')) %>% 
...
medOfEDist = filter(synapses, prepost == 1) %>% group_by(bodyid, modality) %>%
            summarize(med = median(normEDist)) %>%
            filter(modality %in% c('PFLs', 'DNa03', 'MZ_inter')) %>%
            group_by(bodyid) %>%
...
```{r}
  ...
  geom_line(aes(x = factor(modality, levels = c('PFLs', 'DNa03', 'MZ_inter')), y = med,  group = factor(bodyid), color = factor(eg)), position = position_dodge(0.5), size = 0.5) +
  geom_point(aes(x = factor(modality, levels = c('PFLs', 'DNa03', 'MZ_inter')), y = med, fill = modality, group = factor(bodyid)), color = 'black', pch = 21, position = position_dodge(0.5), size = 3, alpha = 0.75) +
  theme_paper() +
  guides(fill = 'legend') +
...
if(savePlot){
ggsave(paste('medianDists_hive_jitter_', nronType, '_ED.pdf', sep = ""), plot = medHivePlot, device='pdf', path = "cole_plots")
}
...
if(savePlot){
  ggsave(paste('medianDists_hive_jitter_', nronType, '_RD.pdf', sep = ""), plot = medHivePlot, device='pdf', path='cole_plots')
}
...
if(savePlot){
ggsave(paste('medianDists_hive_jitter_', nronType, '_motorED.pdf', sep = ""), plot = medHivePlot, device='pdf', path = "cole_plots")
}
...
if(savePlot){
ggsave(paste('medianDists_hive_jitter_', nronType, '_msED.pdf', sep = ""), plot = medHivePlot, device='pdf', path = "cole_plots")
}
...
if(savePlot){
ggsave(paste('medianDists_hive_jitter_', nronType, '_ivED.pdf', sep = ""), plot = medHivePlot, device='pdf', path = "cole_plots")
}
...
if(savePlot){
ggsave(paste('medianDists_hive_jitter_', nronType, '_cvED.pdf', sep = ""), plot = medHivePlot, device='pdf', path = "cole_plots")
}
...
if(savePlot){
ggsave(paste('medianDists_hive_jitter_', nronType, '_sleepED.pdf', sep = ""), plot = medHivePlot, device='pdf', path = "cole_plots")
}
...
if(savePlot){
ggsave(paste('rankOrdering_', nronType, '_ED.pdf', sep = ""), plot = rankOrderingPlot, device='pdf', path = "cole_plots")
}
```
...
if(savePlot){
ggsave(paste('distDistance_', nronType, '_ED.pdf', sep = ""), plot = distDistancePlot, device='pdf', path = "cole_plots")
}
```
...
if(savePlot){
ggsave(paste('depthVsRadial_', nronType, '_ED.pdf', sep = ""), plot = depthVRadDensPlot, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
if (savePlot){
ggsave(paste('depthVsRadial_', nronType, '_RD.pdf', sep = ""), plot = depthVRadDensPlot, path = "cole_plots", device='pdf', scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
```{r}
depthVRadMod = ggplot(filter(synapses, prepost == 1, modality %in% c('pfl3', 'pfl2'))) +
...
if(savePlot){
ggsave(paste('depthVsRadial_modalities_',nronType,'.pdf', sep = ""), plot = depthVRadMod, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
if(savePlot){
ggsave(paste('depthVsRadial_modalities_',nronType,'_motor.pdf'), plot = depthVRadMod, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
if(savePlot){
ggsave(paste('depthVsRadial_modalities',nronType,'_ms.pdf'), plot = depthVRadMod, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
if(savePlot){
ggsave(paste('depthVsRadial_modalities',nronType,'_iv.pdf'), plot = depthVRadMod, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
if(savePlot){
ggsave(paste('depthVsRadial_modalities',nronType,'_cv.pdf'), plot = depthVRadMod, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
...
if(savePlot){
ggsave(paste('depthVsRadial_modalities',nronType,'_sleep.pdf'), plot = depthVRadMod, device='pdf', path = "cole_plots", scale = 1.5, width = 7, height = 7, units ="cm", dpi = 600, limitsize = TRUE)
}
